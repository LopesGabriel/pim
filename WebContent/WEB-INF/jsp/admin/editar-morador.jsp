            ...
            <div class="col">
                ...
                <form>
                    <div class="form-label-group mb-3">
                        <input type="text" id="inputNome" class="form-control" placeholder="Nome" value="Gabriel Lopes" required autofocus>
                    ...
                    <div class="form-label-group mb-3">
                        <input type="text" id="inputEmail" class="form-control" placeholder="E-mail" value="lopesgabriel@gmail.com">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select" id="inputBloco">
                            ...
                            <option selected>Morador</option>
